...
MINIZ_FLAGS := -DMINIZ_NO_MALLOC -DMINIZ_NO_STDIO -DMINIZ_NO_TIME -DMINIZ_NO_ARCHIVE_APIS -DMINIZ_NO_ZLIB_COMPATIBLE_NAMES -DNDEBUG
SHARED_FLAGS += -Isrc -Ithird_party -Ithird_party/miniz -Iplatforms/$(PLATFORM) $(MINIZ_FLAGS) -DPLATFORM_$(PLATFORM)=1
CFLAGS += $(SHARED_FLAGS) $(CLIFLAGS)
